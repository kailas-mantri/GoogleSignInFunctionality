...
import com.onlyforfuture.helpinghands.Models.UserFavoritesModel;
import com.onlyforfuture.helpinghands.Models.UserOrganizationImagesAdapter;
...
public class OrganisationDetailActivity extends AppCompatActivity {
    ...
    String organizationType, organizationTitle, organizationLocation, organizationDescription, organizationLogo, organizationCategory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(OrganisationDetailActivity.this,OrganizationViewImagesActivity.class);
        ...
        reference.child(organizationID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    GetOrganizationListDataModel dataModel = dataSnapshot.getValue(GetOrganizationListDataModel.class);
                    ...
                    Glide.with(getApplicationContext())
                            ...
                            .into(imageView);
                    UserOrganizationImagesAdapter adapter = new UserOrganizationImagesAdapter(OrganisationDetailActivity.this,extraImages);
                    gridView.setAdapter(adapter);
                    loader.setVisibility(View.GONE);
                    layout.setVisibility(View.VISIBLE);
                }
                else {
                    Toast.makeText(OrganisationDetailActivity.this, "Something Went Wrong Please Try Again", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(OrganisationDetailActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void openDialogforAddFavorite() {
        AlertDialog dialog = new AlertDialog.Builder(OrganisationDetailActivity.this)
                .setTitle("Add To Favorites")
                .setMessage("Click Yes to add "+organizationTitle+" to your favorites section to easily access it again.")
                .setCancelable(false)
                .setIcon(R.drawable.donation_app_logo)
    ...
    private void addOrganizationToFavorites() {
        ...
        favoritesReference.child(userID).child(organizationID).setValue(model).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(OrganisationDetailActivity.this, "Organization Added To Your Favorites", Toast.LENGTH_SHORT).show();
                loader.setVisibility(View.GONE);
                recreate();
                finish();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                loader.setVisibility(View.GONE);
                Toast.makeText(OrganisationDetailActivity.this, "Failed To Add Organization. Please Try Again Later", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void deleteOrganizationFromFavorites() {
        favoritesReference.child(userID).child(organizationID).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Toast.makeText(OrganisationDetailActivity.this, "Organization Removed Successfully from Favorites Section.", Toast.LENGTH_SHORT).show();
                loader.setVisibility(View.GONE);
                recreate();
                finish();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                loader.setVisibility(View.GONE);
                Toast.makeText(OrganisationDetailActivity.this, "Failed To Remove Organization From Favorites. Please Try Again Later.", Toast.LENGTH_SHORT).show();
            }
        });
    }

    public void DonateMoney(View view) {
        Intent intent = new Intent(OrganisationDetailActivity.this,MakePaymentActivity.class);
